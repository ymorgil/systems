...
| <br>`ls` | Lista los archivos y carpetas en el directorio actual<br>Lista con detalles <br>Muestra archivos ocultos| `ls`<br>`ls -l` <br>`ls -a` |
| <br>`cd` | Cambia al directorio especificado <br> Retrocede un nivel en el árbol de directorios <br> Cambia al directorio principal del usuario | `cd /var/www` <br> `cd ..`<br>`cd ~` |
...
| `rm` | Elimina un archivo <br> Elimina un directorio y su contenido recursivamente | `rm archivo.txt`<br> `rm -r carpeta_vieja`|
...
|**Búsqueda**{:.yerbold}|||
| `grep <texto> <archivo>` | Busca texto específico dentro de un archivo <br> Búsqueda sin distinguir mayúsculas/minúsculas| `grep "ERROR" app.log`<br> `grep -i "texto" archivo.txt` |
...
!!! tip "Uso de las comillas" 
    ...
    |||
    |||
    |![comillas](../assets/img/05script/bash-01.png)|![comillas](../assets/img/05script/bash-02.png)|
...
!!! question "Ejercicios del 01 al 40 de la sección [Ejercicios BASH](./100-ejercicios-bash.md){:target="_blank"}" 
...
!!! question "Ejercicios del 41 al 60 de la sección [Ejercicios BASH](./100-ejercicios-bash.md){:target="_blank"}" 
...
!!! question "Ejercicios del 61 al 80 de la sección [Ejercicios BASH](./100-ejercicios-bash.md){:target="_blank"}" 
...
!!! question "Ejercicios del 81 al 90 de la sección [Ejercicios BASH](./100-ejercicios-bash.md){:target="_blank"}" 
...
1. La **secuencia** inicial prepara las variables.
2. El bucle **for** (repetitiva) recorre la lista de servicios.
3. Cada vuelta del for usa un **if** (condicional) para decidir qué hacer.
4. Una **función** (`comprobar_servicio`, que usa `return` para señalar éxito/fracaso, y `formatear_linea`, que usa `echo` capturado indirectamente al imprimir directamente el resultado)
5. Al final un **case** (otra estructura condicional) resume el resultado global.

!!! question "Ejercicios del 91 al 100 de la sección [Ejercicios BASH](./100-ejercicios-bash.md){:target="_blank"}" 

## Depuración y Pruebas

Bash incluye opciones que ayudan a detectar errores en un script sin necesidad de añadir `echo` por todos lados.

!!! tip "`bash -n script.sh`{:.yercod} → verifica sintaxis sin ejecutar."
    ...
    - Si todo está bien, no muestra nada y el código de salida es `0`.
    - Si hay un error, indica la línea y el tipo de problema:

!!! tip "`bash -x script.sh`{:.yercod} → modo debug (muestra ejecución línea a línea)."
