# Repositorio de Yeray Moreno

<div style="min-width:33.33%; height:180px; overflow:hidden; border-radius:10px; margin: 1rem 0 1.5rem;">
  <img src="assets/img/index.gif" style="width:100%; height:180px; object-fit:cover;">
</div>
...
|--------|-------------|-------|
| [Administración de Sistemas Operativos](11add/00-introduccion.md) | Instalación, configuración y administración de SO | 2º CFGS |
| [Big Data Aplicado](12biu/00-introduccion.md) | Bases de datos, Spark, Kafka, Power BI... | 1º CE |
